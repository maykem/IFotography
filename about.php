		...
		<div id="colorlib-main">
			<section class="ftco-section bg-light ftco-bread">
	          ...
	          <div class="col-md-9 ftco-animate">
	            ...
	            <p>O IFotografias é um site de fotos dos campi de todo o Tocantins reunidos em um único lugar, aqui você pode conhecer e visitar os outros capi sem sair de casa!</p>
	          </div>
	        </div>
			</div>
			</section>
